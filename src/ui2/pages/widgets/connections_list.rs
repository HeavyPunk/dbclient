...
use crate::{config::Connection, dbclient::{dummy::DummyFetcher, fetcher::Fetcher, redis::{RedisConfig, RedisFetcher}}, ui2::{pages::query::QueryPage, Widget}};
...
{
    fn render(&mut self, frame: &mut ratatui::Frame, rect: &ratatui::prelude::Rect, is_selected: bool) {
    ...
    fn react_on_event(&mut self, terminal: &mut Terminal<TerminalBackend>, event: crate::ui2::UiEvent) -> crate::ui2::WidgetReaction {
        match event {
